...
public class RadioApp extends FragmentActivity {
	...
	private class ReadSongTask extends AsyncTask<String, Void, Boolean> {
		...
		protected void onPostExecute(Boolean result) {
			...
			List<Favorite> favorites = RadioApp.this._dataSource.getAllFavorites();
			...
			if (isChecked)
				RadioApp.this._favoriteCheckbox.setChecked(true);
			else
				RadioApp.this._favoriteCheckbox.setChecked(false);
